...
int *init_ds(World *world, Queue *queue) {
    ...
    int *visited = new int[world->r * world->c,sizeof(int)];
...
int main() {
    ...
    cin>>world.r>>world.c>>world.g_r>>world.g_c>>world.l_r>>world.l_c;
    while (world.r == 6 && world.c == 6 && world.g_r == 6 && world.g_c == 6 && world.l_r == 6 && world.l_c == 6) {
